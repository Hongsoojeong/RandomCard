...
class SelectCardFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding = FragmentSelectCardBinding.inflate(inflater, container, false)
    ...
    private fun navigate(view:View){
        var card : Int = (1..4).random()
        val bundle = bundleOf("people" to 4.toString(), "card" to card)
        view.findNavController().navigate(R.id.action_SelectCardFragment_to_ResultCardFragment, bundle)
    }
